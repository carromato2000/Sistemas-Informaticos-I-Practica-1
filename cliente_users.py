...
def main(silent=False):
    ...
    r = requests.post(f"{USERS}/users", json={"name": "admin", "password": "admin"}, headers=headers_admin)
    ...
    r = requests.delete(f"{USERS}/users/{admin_id}", headers=headers_admin)
    ...
    r = requests.delete(f"{USERS}/users/1234", headers=headers_admin)
...
def setup(silent=False):
    ...
    r = requests.post(f"{USERS}/users", json={"name": "alice", "password": "secret"})
